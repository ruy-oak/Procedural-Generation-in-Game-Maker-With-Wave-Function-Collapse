...
for (var i = 0; i < global.dungeon_size; ++i) {
    for (var j = 0; j < global.dungeon_size; ++j) {
		...
		if (global.dungeon_cells[# i, j] == 1) && global.dungeon_cell_types[# i, j] == "aqua" _c = c_aqua;
...
draw_text(512,256+32, global.dungeon_cell_types[# global.dungeon_actual_x, global.dungeon_actual_y])
